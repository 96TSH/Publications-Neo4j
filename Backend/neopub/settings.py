"""
Django settings for neopub project.
...
SECRET_KEY = "django-insecure-lkalealk7%6_(8#y7(d@w32kqg_4ck=6m%v)q+9ybp4j9p(*z#"
...
WSGI_APPLICATION = "neopub.wsgi.application"
